      ...
      const process = async (typePeople, amount) => {
         try {
            ...
            if (res.status === 204) {
               ...
               return toast.warning('Sorry about that you have booked more than 10 tickets pending, You must pay it!');
               ...
               <div className={cx('cardFooter')}>
                  <div className={cx('payMethods')}>
                     ...
                     <InputField
                        ...
                        defaultChecked
                     />
                     <InputField id='onlinePayment' name='payMethods' label='Online payment via momo' type='radio' />
                  </div>
