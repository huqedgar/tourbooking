            ...
            if (res.status === 200) {
               ...
               dispatch({
                  ...
                  payload: {
                     ...
                     avatar:
                        avatar.current.files.length > 0 ? URL.createObjectURL(avatar.current.files[0]) : account.avatar
                  }
               });
               handleDeleteAvt();
         ...
         <div className={cx('infoBox')}>
            ...
            <div className={cx('inputFlex')}>
               ...
               <InputField
                  ...
                  type='date'
                  name='date_of_birth'
                  value={account.date_of_birth ? moment.tz(account.date_of_birth, 'UTC').format('YYYY-MM-DD') : ''}
                  onChange={setValue}
               />
            </div>
            <InputField
