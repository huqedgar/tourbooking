      ...
      <section id='about' className={cx('container')}>
         ...
         <div className={cx('aboutBox')}>
            ...
            <div className={cx('aboutRight')}>
               ...
               <p>
                  Ea ut eu duis mollit. Consectetur aliqua dolore deserunt veniam magna esse elit qui. Pariatur ullamco
                  enim exercitation amet minim dolore. Aliquip laborum quis ipsum in. Voluptate veniam sit Lorem
                  excepteur eu commodo esse quis aute. Quis amet Lorem duis reprehenderit commodo anim laboris aliqua
                  deserunt dolore minim aliquip.
               </p>
               <p>
