    ...
    return (
        <div className={cx('modalBackground')} {...props}>
            <div className={cx('modalContent')}>
                ...
                <p>
                    We are processing your order and will contact you as soon as possible to complete the transaction.
                    For any questions, please contact the hotline: 0344564075 or email: vhung6252@gmail.com for timely
                    support.
                </p>
            </div>
        </div>
